...
- Divergence closure: every item in FR §5.3 (all seventeen: CBCRD02 RC4/EMPTY, CBCRD08 RC8/OUTOFBAL, FORCEOPEN, U0602/U0603, ≤4-vs-≤8 gate, U0632/U0606, scheduler U4001–U4010, CBCRD05A unroutable-fee RC, missing 05A/05B re-run DELETE, WAIT=030 vs WAIT=000, CBCRD05B control-card failure, JCL/runbook abend labels absent from source, CBCRD06B unresolvable risk route, FEEPARM card dataset with no supplying DD, unreachable RC 8 in CBCRD01/03/04/07/08, CBCRD08 same-date re-run double-roll, CBCRD07 partial-ledger rollback) carries an explicit reconciliation decision in the owning program's FR doc.
